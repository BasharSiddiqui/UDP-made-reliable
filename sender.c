...
struct packet packets[10]; // window size is 10
int temp_seq_no = 1;
int no_of_acks;
int temp_ack;
int acks[10];
...
int main(int argc, char *argv[])
{
  ...
  FILE *in = fopen("demo2.mp4", "rb"); // open the video file in read mode
...
FILESIZE:
  ...
  RESEND:
    ...
    // 10 acks have been received i.e. the thread executes successfully
